...
class PDFService
{
    ...
    {
        $html .= '<style>'.file_get_contents($this->appKernel->getProjectDir() .  "/public/resume/fontawesome/js/all.min.js").'</style>';


        $html .= '<style>'.file_get_contents($this->appKernel->getProjectDir() .  "/public/dashboard/assets/css/nucleo-icons.css").'</style>';
        $html .= '<style>'.file_get_contents($this->appKernel->getProjectDir() .  "/public/dashboard/assets/css/nucleo-svg.css").'</style>';
        $html .= '<script src="https://kit.fontawesome.com/42d5adcbca.js" crossorigin="anonymous"></script>';
        $html .= '<style>'.file_get_contents($this->appKernel->getProjectDir() .  "/public/dashboard/assets/css/material-dashboard.css").'</style>';
